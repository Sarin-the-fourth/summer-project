      ...
      <div className="m-20 relative text-white">
        ...
        <div className="backdrop-blur-md bg-white/20 p-8 shadow-lg w-full max-w-md">
          <form>
            ...
            <textarea
              className="textarea text-black p-2 pl-2 w-full mt-2 focus:outline-none focus:shadow-xl bg-transparent placeholder-shown:bg-white transition-all duration-300"
              placeholder="Bio"
            ></textarea>
